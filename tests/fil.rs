...
fn format_fil() {
	...
	assert_eq!(dt.formatl("%b", locale).to_string(), "Hul");
	assert_eq!(dt.formatl("%B", locale).to_string(), "Hulyo");
	assert_eq!(dt.formatl("%h", locale).to_string(), "Hul");
	...
	assert_eq!(dt.formatl("%a", locale).to_string(), "Lin");
	assert_eq!(dt.formatl("%A", locale).to_string(), "Linggo");
	...
	assert_eq!(dt.formatl("%v", locale).to_string(), " 8-Hul-2001");
	...
	assert_eq!(dt.formatl("%c", locale).to_string(), "Lin Hul  8 00:34:60 2001");

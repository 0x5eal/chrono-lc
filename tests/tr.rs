...
fn format_it() {
	...
	assert_eq!(dt.formatl("%b", locale).to_string(), "Tem");
	assert_eq!(dt.formatl("%B", locale).to_string(), "Temmuz");
	assert_eq!(dt.formatl("%h", locale).to_string(), "Tem");
	...
	assert_eq!(dt.formatl("%a", locale).to_string(), "Paz");
	assert_eq!(dt.formatl("%A", locale).to_string(), "Pazar");
